...
export default class Example extends PureComponent {
  ...
  componentDidMount() {
    fetch("http://localhost:5000/api/cases/1")
      .then((res) => res.json())
      .then((cases1) => this.setState({ cases1 }));

    fetch("http://localhost:5000/api/cases/2")
      .then((res) => res.json())
      .then((cases2) => this.setState({ cases2 }));

    fetch("http://localhost:5000/api/cases/3")
      .then((res) => res.json())
      .then((cases3) => this.setState({ cases3 }));

    fetch("http://localhost:5000/api/cases/4")
      .then((res) => res.json())
      .then((cases4) => this.setState({ cases4 }));

    fetch("http://localhost:5000/api/cases/5")
      .then((res) => res.json())
